...
genomes. In addition to the use of the BigJob tool, we have done extensive performance analysis of the
...
sequenced position mlRho reads a profile consisting of the number of \texttt{A}s, \texttt{C}s, \texttt{G}s, and \texttt{T}s from a file. 
...
step. %, because we found that this was faster.
