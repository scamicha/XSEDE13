...
\maketitle
\begin{abstract}
An increasing number of researchers are outgrowing their desktops and turning to supercomputers to run their simulations and do their calculations. But today's computational problems are bigger than what individual universities can handle. XSEDE is the first place researchers turn to when they outgrow their campus resources. XSEDE machines are far larger (at least by an order of magnitude) than what most universities offer. XSEDE has taken many steps to bridge this difference, such as the Campus Bridging initiative, the Campus Champions program, Extended Collaborative Support program and through education and outreach. 
\end{abstract}
