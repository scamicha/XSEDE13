...
\maketitle
\begin{abstract}
  An increasing number of biologist's computational demands have outgrown the capacity of desktop
...
ing a Campus Champion) dissect a computationally intensive biology project and share the insights we have gained
  ...
  recombination rates of tens of genome profiles using the mlRho \cite{MEC:MEC4482}, a serial,
  ...
  campus bridging expert to play in bridging the gaps between existing programs and present mlRho as an ideal
  example case.
\end{abstract}
