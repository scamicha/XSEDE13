...
\category{B.8.2}{Hardware}{Performance and Reliability}[Miscellaneous]
%A category including the fourth, optional field follows...
\category{D.2.8}{Software Engineering}{Metrics}[complexity measures, performance measures]
\category{J.3}{Computer Applications}{Life and Medical Sciences}[Biology and genetics]

\terms{Performance, Experimentation, Design, Reliability, Human Factors}
